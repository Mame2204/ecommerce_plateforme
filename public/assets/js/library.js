...
export const addCompareEventListener = () => {
    let links = document.querySelectorAll(".add-to-compare, .compare_table .remove_compare_item, a.add-to-cart")
    console.log({ links });
    links.forEach(link => {
...
export const addCartEventListenerToLink = () => {
    ...
    let add_to_cart_links = document.querySelectorAll('a.add-to-cart, li.add-to-cart a, a.item_remove,  a.btn-addtocart')
...
export const displayCart = (cart = null) => {
    ...
    //let cart_sub_total_amount = document.querySelector('.cart_total_amount')
    //let cart_shipping_total_amount = document.querySelector('.cart_total_amount_shipping')
